...
void UCombatComponent::EquipWeapon(AWeapon* WeaponToEquip)
{
	...
	if (const USkeletalMeshSocket* HandSocket = Character->GetMesh()->GetSocketByName(FName("Hand_rSocket")))
	{
...
void UCombatComponent::SetHUDCrosshairs(float DeltaTime)
{
	...
	if (Controller)
	{
		...
		if (HUD)
		{
			if (EquippedWeapon)
			{
				HUDPackage.CrosshairsCenter = EquippedWeapon->CrosshairsCenter.LoadSynchronous();
				HUDPackage.CrosshairsLeft = EquippedWeapon->CrosshairsLeft.LoadSynchronous();
				HUDPackage.CrosshairsRight = EquippedWeapon->CrosshairsRight.LoadSynchronous();
				HUDPackage.CrosshairsTop = EquippedWeapon->CrosshairsTop.LoadSynchronous();
				HUDPackage.CrosshairsBottom = EquippedWeapon->CrosshairsBottom.LoadSynchronous();
			}
			else
			{
...
void UCombatComponent::InitializeCarriedAmmo()
{
	...
	CarriedAmmoMap.Add(EWeaponType::EWT_SubmachineGun, StartingPistolAmmo);
}
